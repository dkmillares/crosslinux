...
PKG_ZIP="cloog-0.16.1.tar.gz"
PKG_SUM=""

PKG_TAR="cloog-0.16.1.tar"
PKG_DIR="cloog-0.16.1"
...
CFLAGS="-I${CONFIG_XTOOL_BIN_DIR}/../${CONFIG_XTOOL_NAME}/include -fexceptions ${CONFIG_CFLAGS}" \
./configure \
	--build=${MACHTYPE} \
	--host=${CONFIG_XTOOL_NAME} \
	--prefix=/usr \
	--with-gmp-prefix=${TARGET_SYSROOT_DIR}/usr \
	--enable-shared \
